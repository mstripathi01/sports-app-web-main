...
import LevelExerciseFormSection from "@/sections/dashboard/videos/level/exerciseForm";
  ...
  return (
    <ContainerComponent>
      ...
      <form noValidate onSubmit={formik.handleSubmit}>
        <LevelExerciseFormSection formik={formik} />
        <Stack alignItems="flex-end" sx={{ mt: 3 }}>
          ...
          >
            {id === "new" ? "Add Exercise" : "Edit Exercise"}
          </LoadingButton>
        </Stack>
      </form>
    </ContainerComponent>
...
VideoExercise.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;
