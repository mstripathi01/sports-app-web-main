...
import CompleteUsersDetail from "@/sections/dashboard/videos/level/completeUsersDetail";
...
const CompleteUsersDetailPage = () => {
  const router = useRouter();
  const { push } = useRouter();

  const title = "Complete Users";
...
CompleteUsersDetailPage.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;
export default CompleteUsersDetailPage;
