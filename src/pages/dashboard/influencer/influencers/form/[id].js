...
import { InfluencerFormSection } from "@/sections/dashboard/influencer";
...
const NotificationForm = () => {
  ...
  const backUrl = `${PATH_DASHBOARD.influencer.influencers}`;
  const actionUrl = "#";
  ...
  return (
    <ContainerComponent>
      ...
      <form noValidate onSubmit={formik.handleSubmit}>
        <InfluencerFormSection formik={formik} />
        <Stack alignItems="flex-end" sx={{ mt: 3 }}>
          ...
          >
            {id === "new" ? "Create Influencer" : "Update Influencer"}
          </LoadingButton>
        </Stack>
      </form>
    </ContainerComponent>
